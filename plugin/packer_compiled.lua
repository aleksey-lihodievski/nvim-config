...
_G.packer_plugins = {
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/Users/aleksejlihodievskij/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ultisnips = {
    loaded = true,
    path = "/Users/aleksejlihodievskij/.local/share/nvim/site/pack/packer/start/ultisnips",
