...
-- vim.keymap.set("n", "]e", vim.diagnostic.goto_next({ severity = vim.diagnostic.severity["ERROR"] }), opts)
-- vim.keymap.set("n", "]e", vim.diagnostic.goto_prev({ severity = vim.diagnostic.severity["ERROR"] }), opts)
--
-- vim.keymap.set("n", "]w", vim.diagnostic.goto_next({ severity = vim.diagnostic.severity["WARN"] }), opts)
-- vim.keymap.set("n", "]w", vim.diagnostic.goto_prev({ severity = vim.diagnostic.severity["WARN"] }), opts)
